...
class __TwigTemplate_25131cc425ad0400b87ef08820747f88 extends Template
{
      ...
      <tbody>
        ...
        if (($context["zones"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["zone"]) {
                // line 16
                yield "            <tr";
                if ( !CoreExtension::getAttribute($this->env, $this->source, $context["zone"], "status", [], "any", false, false, false, 16)) {
...
", "admin/view/template/localisation/zone_list.twig", "C:\\xampp\\htdocs\\rizkistore\\admin\\view\\template\\localisation\\zone_list.twig");
    }
}
